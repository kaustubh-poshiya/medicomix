        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-6">
              <div className="bg-gradient-to-tr from-secondary-500 to-primary-600 p-1.5 rounded-lg text-white">
                <Activity size={20} />
              </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/consult" className="hover:text-primary-400 transition-colors">Consult a Doctor</Link></li>
              <li><Link to="/products" className="hover:text-primary-400 transition-colors">Health Products</Link></li>
              <li><Link to="/about" className="hover:text-primary-400 transition-colors">About Us</Link></li>
              <li><Link to="/contact" className="hover:text-primary-400 transition-colors">Support Center</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/join" className="hover:text-primary-400 transition-colors">Join Platform</Link></li>
              <li><Link to="#" className="hover:text-primary-400 transition-colors">Resources</Link></li>
              <li><Link to="#" className="hover:text-primary-400 transition-colors">Case Studies</Link></li>
              <li><Link to="#" className="hover:text-primary-400 transition-colors">Partner with Us</Link></li>
            </ul>
          </div>
